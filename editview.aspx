...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="table2">
    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="recID" DataSourceID="SqlDataSource1" Height="50px" style="margin-right: 77px; margin-left: 0px;" Width="263px" DefaultMode="Insert" ClientIDMode="Predictable">
        <Fields>
